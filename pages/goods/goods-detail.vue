<template>
	<view>
		<view class="flex flex-direction">
			...
			<view>
				<view :class="'cuIcon-right'">查看全部报价价</view>
			</view>
			<view class="flex flex-direction platform-service align-start justify-center padding-sm">
				...
				<view class="flex margin-top-sm justify-start align-center">
					<view class="text-sm" :class="'cuIcon-roundcheck'">
					</view>
					<view class="platform-service-item">
						平台联合鉴别
					</view>
					<view class="margin-left-sm" :class="'cuIcon-roundcheck'">
					</view>
					<view class="platform-service-item">
						正品保障
					</view>
			...
			<view class="flex padding-sm bg-white">
				...
				<view class="flex align-center">
					...
					<view :class="'cuIcon-triangledownfill'" :style="'font-size:40rpx'">
					</view>
				</view>
			</view>
			<view v-for="(item, index) in transRecordList" :key="item.id" class="uni-tab-item bg-white" :id="item.id" :data-current="index" @tap="tabSelect">
				<view class="flex trans-record-item align-center justify-center">
					...
					<view class="flex align-center justify-center" :style="'width:50%'">
						...
						<view class="trans-record-item-content">{{item.type}}</view>
					</view>
			...
			<view class="flex padding-sm bg-white">
				...
				<view class="bg-add-comment flex align-center justify-center">
					<view  class="text-black text-lg" :class="'cuIcon-add'">
						添加
					</view>
				</view>
